...
/**
 * mvn -f practice_12_solution/pom.xml clean install exec:java -Dexec.args="Denis 27"
 * mvn -f practice_12_solution/pom.xml clean install exec:java -Dargs="Denis 27"
 */
